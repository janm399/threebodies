...
我们不能这么问，应该这样问：“为了实现最可靠的，最可维持的代码该怎么办？” 换句话说，最常遇到的问题是什么？首先，需要仔细地定义“问题”究竟意味着什么。
...
那么，副作用主要点是什么？回想第一句话：我们的最终目的是避免不确定性，我们知道命令式代码依赖”一行一行”地进行的方法来表达该顺序。算法不是依靠确切运算的顺序吗？是的，回想最后一次你确实需要实现复杂算法

与其


虽然一步一步地进行的方法难以分布化、平行化，但是全部地保证顺序
