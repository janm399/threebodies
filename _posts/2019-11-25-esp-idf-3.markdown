...
因为2812是个big endian，可是ESP32是个little endian，因此我们需要把每一个颜色字段变成big endian，所以下面的代码包含endian变成的行8、9、10，这也是传输的代码唯一个难点。big endian的意思是整数是于最重要比特开始的，比如使用big endian的系统会以223——$$8b$$装下的值——为$$00100010011$$，反而little endian会把223当同于$$11001000100$$。
